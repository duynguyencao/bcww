...
router.get("/photosOfUser/:id", auth, async(req, res) => {
    try {
...
router.post("/commentsOfPhoto/:id", auth, async(req, res) => {
...
router.post("/photos/new", auth, upload.single("photo"), async(req, res) => {
    try {
